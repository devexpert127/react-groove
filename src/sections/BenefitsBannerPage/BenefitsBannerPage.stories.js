...
import { withKnobs, text, html, files, boolean } from '@storybook/addon-knobs'
import BenefitsBannerPage from './'

export default {
  title: 'Banner / Benefits Banner Page',
  component: BenefitsBannerPage,
...
export const benefitsBannerPage = () => {
  const benefitImages = {
    desktopImage: {
      src: files(
        'Desktop Image',
