...
import BenefitsBannerProductCollection from './'

export default {
  title: 'Banner / Benefits Banner Product Collection',
  component: BenefitsBannerProductCollection,
...
export const benefitsBannerProductCollection = () => {
  const collection = {
    benefitImages: '',
    benefits: '',
  }
  ...
  collection.benefitImages = benefitImages
  collection.benefits = benefits
  collection.hideMasterPageSections = boolean('Hide master page section?', false)

  return (
    <BenefitsBannerProductCollection
