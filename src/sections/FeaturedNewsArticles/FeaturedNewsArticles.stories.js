...
import FeaturedNewsArticles from './'

export default {
  title: 'Blog / Featured News Articles',
  component: FeaturedNewsArticles,
  decorators: [withKnobs],
}

export const featuredNewsArticles = () => {
  const articles = [
    {
      featureImage: {
        src: files(
  ...
  return <FeaturedNewsArticles articles={articles} />
}
