...
import BenefitsBannerCustomCollection from './'

export default {
  title: 'Banner / Benefits Banner Custom Collection',
  component: BenefitsBannerCustomCollection,
...
export const benefitsBannerCustomCollection = () => {
  const collection = {
    benefitImages: '',
    benefits: '',
  }
  ...
  return (
    <BenefitsBannerCustomCollection
